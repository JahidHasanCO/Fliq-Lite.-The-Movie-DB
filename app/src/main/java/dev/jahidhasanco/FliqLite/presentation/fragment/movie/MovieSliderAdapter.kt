...
import dev.jahidhasanco.FliqLite.databinding.SingleMovieSliderBinding
import dev.jahidhasanco.FliqLite.presentation.activity.youtubePlayer.YoutubeVideoPlayerActivity
...
class MovieSliderAdapter(private val context: Context) : SliderViewAdapter<MovieSliderAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.viewHolder.playBtn.setOnClickListener {
            ...
            val movieId:String = this.list[position].idMovie.toString()
